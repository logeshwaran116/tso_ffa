...
from bascenev1._gameutils import show_damage_count
from bascenev1lib.actor.playerspaz import PlayerSpaz
from bascenev1lib.actor.powerupbox import PowerupBox
from bascenev1lib.actor.spazbot import SpazBotSet, ExplodeyBotNoTimeLimit
...
class Blast(bs.Actor):
    ...
    def __init__(self,
        ...
        lpos = light.position
        explosion_sounds = ['explosion01', 'explosion02', 'explosion03', 'explosion04', 'explosion05']
        bs.getsound(random.choice(explosion_sounds)).play()
        bs.getsound(random.choice(explosion_sounds)).play()
        bs.getsound('debrisFall').play()
...
class TNTBox(bs.Actor):
    ...
    def __init__(self,
        ...
        self._model = bs.getmesh('meterTransparent')
        ...
        if modeltype == 1:
            ...
            self.node = bs.newnode(
                ...
                attrs={
                    ...
                    'body': 'crate',
                    'body_scale': 1,
                    'mesh_scale': self._mymodel_scale,
                    'shadow_size': 0.3,
                    'color_texture': bs.gettexture('tnt'),
                    'is_area_of_interest': True,
                    'reflection': 'soft',
...
class TNTTeamGame(bs.TeamGameActivity[Player, Team]):
    ...
    def get_instance_description(self) -> Union[str, Sequence]:
        return 'Destroy the enemy\'s team box.'
