...
class mega_mine_defs:
    ...
    points['spawn1'] = (2.5, 3, -2.0) + (0.5, 1.0, 2.0)  # Reduced Y from 8 to 7
    points['spawn2'] = (-2.5, 3, -2.0) + (0.5, 1.0, 2.0)  # Reduced Y from 8 to 7


class MegaMine(bs.Map):
    """A giant mine!"""
