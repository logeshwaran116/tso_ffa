...
def log(msg: str, mtype: str = "sys") -> None:
    ...
    if SETTINGS["discordbot"]["enable"]:
        message = msg.replace("||", "|")
        if mtype == 'chat':
            discord_bot.push_log(":scroll: " + message)
        elif mtype == 'playerjoin':
            discord_bot.push_log(":loudspeaker: " + message)
        elif mtype == "chatcmd":
            discord_bot.push_log(":shield: " + message)
        elif mtype == "ban":
            discord_bot.push_log(":no_entry: " + message)
        else:
            discord_bot.push_log(":dividers: " + message)
